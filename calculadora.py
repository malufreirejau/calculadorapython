...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora da Malu')
        ...
        self.display.setStyleSheet(
            '* {background: #1A0216; color: #FF1493; font-size: 30px;}'
        )
        ...
        self.add_btn(
            ...
            'background: #B22222; color: #fff; font-weight: 700;'
        )
        ...
        self.add_btn(
            ...
            'background: #208072; color: #fff; font-weight: 700;'
        )
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_igual,
            'background: #3F6C0D; color: #fff; font-weight: 700;'
        )
